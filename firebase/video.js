...
/* =========================
guardDirectAccess（導回 emo_index / emo_video）
========================= */
...
try {
    ...
    window.location.replace("emo_video.html");
    return;
    }
} catch (e) {
...
Firestore（emo_users）
========================= */
const COLLECTION_NAME = "emo_users";
...
function renderResumeUI(pos) {
    ...
    el.innerHTML = `
        ...
        <button id="resume-btn" type="button" style="
            ...
            background: var(--emo-color1); cursor:pointer; font-weight:600;
        ">從這裡繼續 ▶</button>
        </div>
    `;
}
